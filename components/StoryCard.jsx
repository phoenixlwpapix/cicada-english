...
const StoryCard = forwardRef(function StoryCard(
  ...
  // Auto-generate audio when story is generated
  useEffect(() => {
    // Only auto-generate audio when story is first loaded and not already auto-generated
    if (story && !loading && !autoGenerated && !isGenerating && !isPlaying) {
      // Add a small delay to ensure the UI has updated
      const timer = setTimeout(() => {
        generateAndPlayAudio(story, true).catch((error) => {
