...
// Legacy support - convert old format to new format (no longer needed with Supabase)
export const migrateLegacyData = () => {
  // Since we're now using Supabase, legacy localStorage data migration
  // would need to be handled differently. For now, we'll skip this.
  console.log("Legacy data migration not needed with Supabase");
};
